...
Uses Phase 2 Stage 1 (TF-IDF) results for single models and Phase 4 results for ensemble models
"""
...
def main():
    print("="*80)
    print("Generating Table 4-5: Single vs Ensemble Model Comparison")
    print("="*80)
    ...
    # Load Phase 4 ensemble results
    print("Loading Phase 4 ensemble results...")
    phase4_path = config.RESULTS_DIR / "tables" / "table_phase4_paper_original.csv"
    ...
    # Add ensemble models
    ensemble_mapping = {
        'Voting (Soft)': 'Voting-S',
        'Voting (Weighted)': 'Voting-W',
        'Stacking': 'STK'
    }
